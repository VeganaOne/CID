...
class regresionLineal:
    def __init__(self,x,y):
        ...
        #elevar  al cuadrado el coeficientge de relacion

    def imprimir_ecuacion(self):
        print("Y = ", self.b0, "+", self.b1, "X") #muestra la ecuacion de la recta 
    def predecir(self, x):
        return round(self.b0 + self.b1 *x,2)

    def get_coeficiente_corelacion(self):
        return self.coeficiente_corelacion #retornar el valor de coeficiente de corelacion
    
    def get_coeficiente_determinacion(self):
        return self.coeficiente_determinacion#retorna el valor del coeficiente de determinacion